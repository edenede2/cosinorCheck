...
def all_dates_plot(results, original_data, window_size, period, select_period_size):
    ...
    for key in results.keys():
        ...
        acrophase = quadrant_adjustment(results[key][2]['peaks'][0]/results[key][2]['period'] * 2 * np.pi, results[key][2]['acrophase'])
        ...
        ci_acrophase = [ci_acrophase[1], ci_acrophase[0]]
        ...
        ellipse_theta_deg = ellipse_theta# Convert to degrees for plotting
